...
#define TASK_PERIOD_MS_WIFI 1000
#define OVS_WLAN_RETRY 5
...
#define TCP_TX_SOCKET_BUFFER_SIZE 1024

#define OVS_COMMAND_QUEUE_SIZE 64

#define MAX_SAMPLE_BUFFER_SIZE 96
#define MAX_STATUS_MSG_BUFFER_SIZE 8
...
#define MQTT_CLIENT_PUBLISH_RETRY_DELAY_MS 1000
#define MQTT_TASK_LOOP_MS 1000
